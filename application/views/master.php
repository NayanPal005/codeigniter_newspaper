            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url() ?>admin/add_news"><i class="fa fa-circle-o"></i> Add News</a></li>
                        <li><a href="<?php echo base_url() ?>super_admin/manage_news"><i class="fa fa-circle-o"></i> Manage News</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url() ?>admin/add_category"><i class="fa fa-circle-o"></i> Add Category</a></li>
                        <li><a href="<?php echo base_url() ?>super_admin/manage_category"><i class="fa fa-circle-o"></i> Manage Category</a></li>
